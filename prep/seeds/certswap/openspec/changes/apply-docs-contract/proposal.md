...
certswap is een leverbaar CLI-tool zonder docs/; wave 2 van het handbook.
...
- Nog geen `docs/`: minimum viable — `index.md` + `reference/cli.md`
  (subcommands, formaten) uit README.

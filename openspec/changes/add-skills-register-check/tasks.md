...
- [x] 1.5 Handmatig gerookt (de hub heeft geen test-harness, net als de andere
      scripts): geldige skill slaagt, onbekende faalt, register-weg faalt.
      Reproduceerbaar: draai de gate met een tijdelijk gewijzigde def.
